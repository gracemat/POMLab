/*
 * package com.qa.activecampaign.Listeners; import io.qameta.allure.Attachment;
 ...
 * getTestMethodName(iTestResult) + " failed"); Object testClass =
 * iTestResult.getInstance(); WebDriver driver = BasePage.getDriver(); // Allure
 * ScreenShotRobot and SaveTestLog if (driver instanceof WebDriver) {
 * System.out.println("Screenshot captured for test case:" +
 * getTestMethodName(iTestResult)); saveScreenshotPNG(driver); } // Save a log
 * on allure. saveTextLog(getTestMethodName(iTestResult) +
